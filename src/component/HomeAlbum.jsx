    ...
    <section id="homeAlbum">
      ...
      >
        <div className="albumBoxFullOrangeLeft left">
          <img
            src={albumItem[0].img}
            alt={albumItem[0].name}
            className="albumBoxFullOrangeLeftImg"
          />
          <img
            src={albumItem[0].svg}
            alt={albumItem[0].name}
            className="albumBoxFullOrangeLeftSvg"
          />
        </div>
        <div className="albumBoxFullOrangeRight boxColumn gap_2 left">
          ...
          <Link
            to={"/Product/" + albumItem[0].name}
            state={{
              name: albumItem[0].name,
              desc: albumItem[0].desc,
              img: albumItem[0].img,
              pid: albumItem[0],
            }}
            className="btn_black selfLeft"
          >
            SEE PRODUCT
          </Link>
        </div>
      ...
      >
        <div className="albumBoxFullGrayLeft gap_2">
          ...
          <Link
            to={"/Product/" + albumItem[1].name}
            state={{
              name: albumItem[1].name,
              desc: albumItem[1].desc,
              img: albumItem[1].img,
              pid: albumItem[1],
            }}
            className="btn_transparent selfLeft"
          >
            SEE PRODUCT
          </Link>
        </div>
        <div className="albumBoxFullGeayRightImg boxColumn gap_2">
          <img
            src={albumItem[1].img}
            alt={albumItem[1].name}
            className="albumBoxFullOrangeRightImg"
          />
        </div>
      </motion.div>
      ...
      <div className="albumBoxHulf boxRow">
        ...
        >
          ...
          <Link
            to={"/Product/" + albumItem[2].name}
            state={{
              name: albumItem[2].name,
              desc: albumItem[2].desc,
              img: albumItem[2].img,
              pid: albumItem[2],
            }}
            className="btn_transparent selfLeft"
