...
function CartList() {
  ...
  return cartItems.length > 0 ? (
    <AnimatePresence>
          ...
          delAnimVal !== item.id && (
            ...
            >
              ...
              <div className="boxColumn gap_1">
                {item.isNew && (
                  <p className="text_orange_overLine w_100">NEW PRODUCT</p>
                )}
                ...
                <div className="boxRow gap_2 left w_100 fleWrap">
                  <div className="boxRow bgGray">
                    <button
                      className="p_1"
                      onClick={() => handlerDecBtn(item.pid)}
                    >
                      -
                    </button>
                    ...
                    <button
                      className="p_1"
                      onClick={() => handlerIncBtn(item.pid)}
                    >
                      +
                    </button>
                  </div>
                  ...
                  <button
                    className="btn_red center"
                    onClick={() => handlerDeleteBox(item, item.id)}
                  >
                    x
                  </button>
                </div>
      ...
      <h2 className="center pt_2 pb_2 w_100">total price: ${totalPrice}</h2>
    </AnimatePresence>
  ) : (
